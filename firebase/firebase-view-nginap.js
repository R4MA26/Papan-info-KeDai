...
if (hariini == "Jumat") {
  pemateringinapRef.on("value", dataBerhasilnginap, dataGagalpiket);
  ...
  function dataBerhasilnginap(data) {
    ...
    data.forEach(function (cetak) {
      if (cetak.val().hari == "Jumat") {
        //jika ada data yg harinya == Sabtu
    ...
    view_nginap.innerHTML = value_piket;
  }
